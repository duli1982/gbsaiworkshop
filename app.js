...
function updateSectionVisibility() {
    ...
    const toolPaths = ['what.html', 'builder.html', 'my-library.html', 'simulator.html', 'reverse-prompt.html', 'my-day.html'];
    const toolsDropdownBtn = document.getElementById('tools-dropdown-btn');

    sections.forEach(section => {
        const isVisible = section.id + '.html' === path || (path === 'index.html' && section.id === 'why');
    ...
    if (toolsDropdownBtn) {
        toolsDropdownBtn.classList.toggle('active', toolPaths.includes(path));
    }
}
